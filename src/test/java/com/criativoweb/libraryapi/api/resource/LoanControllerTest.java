...
import com.criativoweb.libraryapi.api.service.LoanServiceTest;
...
public class LoanControllerTest {
    ...
    public void createLoanTest() throws Exception {
        ...
        LoanDTO dto = LoanDTO.builder().isbn("123").customer("Fulano").email("fulano@gmail.com").build();
    ...
    public void createLoanNotFoundTest() throws Exception {
    ...
    public void findLoanTest() throws Exception {
        ...
        Loan loan  = LoanServiceTest.buildLoan("Teste", 1l);
        loan.setId(id);
